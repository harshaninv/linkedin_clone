...
import 'package:provider/provider.dart'; // Adjust the path as needed
                ...
                children: [
                  MaterialButton(
                    ...
                    children: [
                      Icon(
                        Icons.home_filled, 
                        color: currentIndex == 0 ? Color.fromARGB(255, 0, 84, 181) : Colors.blueGrey,
                      ),
                    ],
                  )
                  ),
                  MaterialButton(
                    ...
                    children: [
                      Icon(
                        Icons.group_rounded, 
                        color: currentIndex == 1 ? Color.fromARGB(255, 0, 84, 181) : Colors.blueGrey,
                      ),
                    ],
                  )
                  ),
                ...
                children: [
                  MaterialButton(
                    ...
                    children: [
                      Icon(
                        ...
                        color: currentIndex == 2 ? Color.fromARGB(255, 0, 84, 181) : Colors.blueGrey,
                      ),
                    ],
                  )
                  ),
                  MaterialButton(
                    ...
                    children: [
                      Icon(
                        Icons.work, 
                        color: currentIndex == 3 ? Color.fromARGB(255, 0, 84, 181) : Colors.blueGrey,
                      ),
                    ],
                  )
                  ),
