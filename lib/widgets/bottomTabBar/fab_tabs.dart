...
import 'package:linkedin_clone/views/notification/notifications_page.dart'; // Adjust the path as needed
              ...
              children: [
                MaterialButton(
                  ...
                  children: [
                    Icon(
                      Icons.home_filled, 
                      color: currentIndex == 0 ? Color(0xFF0077B5) : Colors.grey,
                    ),
                  ],
                )
                ),
                MaterialButton(
                  ...
                  children: [
                    Icon(
                      Icons.group_rounded, 
                      color: currentIndex == 1 ? Color(0xFF0077B5) : Colors.grey,
                    ),
                  ],
                )
                ),
              ...
              children: [
                MaterialButton(
                  ...
                  children: [
                    Icon(
                      ...
                      color: currentIndex == 2 ? Color(0xFF0077B5) : Colors.grey,
                    ),
                  ],
                )
                ),
                MaterialButton(
                  ...
                  children: [
                    Icon(
                      Icons.work, 
                      color: currentIndex == 3 ? Color(0xFF0077B5) : Colors.grey,
                    ),
                  ],
                )
                ),
